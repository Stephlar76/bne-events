...
const VENUES = [
  ...
  { id:"v26", cat:"music", name:"The Zoo", suburb:"Fortitude Valley", type:"Live Music Venue", desc:"Brisbane's most long-standing independent live music venue since 1992. Open Wed–Sat. Everything from hip hop and jazz to rock, folk and reggae. Tickets via Oztix.", url:"https://zoo.oztix.com.au/" },
  { id:"v27", cat:"nightlife", name:"The Prince Consort", suburb:"Fortitude Valley", type:"Live Music & Club Venue", desc:"Fortitude Valley's home of electronic music. Basement club nights, live acts and Sunday sessions. Tickets via Moshtix.", url:"https://www.moshtix.com.au/v2/venues/the-prince-consort/7986" },
...
const RECURRING = [
  ...
  // ── SATURDAY ──
  { dow:6, id:"rec_sat_oasis_afternoon", title:"OASIS Saturdays — Afternoon Boat Party", venue:"City Botanic Gardens River Hub", suburb:"Brisbane City", time:"12:30 PM", price:"Ticketed", isFree:false, category:"nightlife", tags:["boat party","dj","nightlife"], description:"Brisbane's ultimate floating party cruise — every Saturday on the Brisbane River. Local and guest DJs across multiple decks, cocktails, city views. Boards at 12:30pm, sails until 5pm. 18+ only.", url:"https://www.eventbrite.com.au/o/oasis-cruising-brisbane-31060917861" },
